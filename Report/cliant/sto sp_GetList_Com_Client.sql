USE [Company]
GO
/****** Object:  StoredProcedure [dbo].[sp_GetList_Com_Client]    Script Date: 1/13/2026 5:20:43 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
	-- Procedure name: [dbo].[sp_GetList_Com_Client]
	-- Function: Get List Client
	-- Create date: 1/4/23
	-- Description:	 
	-- [dbo].[sp_GetList_Com_Client] 3357
	-- Update 25/8/2025 By M
	-- PPP.QTY,PPP.Hiring,PPP.Left_Position
	-- =============================================
ALTER PROCEDURE [dbo].[sp_GetList_Com_Client] 
	@Company_ID INT = 0 AS
...
SET @Position_Type_System = (
	...
	/** 
	 ...
	 INTO #TempTable 
	 from TableName1 t1 
	 left join TableName2 t2 on t1.xxxx = t2.xxxx
	 where .....
...
BEGIN CATCH 
	...
	VALUES (
			'1',
			'DB Company - sp_GetList_Com_Client',
			ERROR_MESSAGE(),
			999,
			GETDATE()
		);
