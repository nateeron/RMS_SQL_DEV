...
DECLARE @Company_ID INT = 1,
    ...
    @DateFromStr VARCHAR(30) = '2026-01-09',
    ...
    --SELECT
    --  Project_Position_ID, Owner_Name,Owner_ID, ' + @SelectColumns + N', ' + @TotalAllExpression + N'
    --FROM OwnerData
    --WHERE Owner_Name IS NOT NULL
    --GROUP BY Project_Position_ID,Owner_Name,Owner_ID
    --ORDER BY Owner_Name;
    ';
