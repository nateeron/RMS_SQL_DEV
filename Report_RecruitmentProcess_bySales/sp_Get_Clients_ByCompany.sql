...
GO
-- =============================================
-- Get Client_ID and Client_Name only (all distinct) by Company_ID
-- Usage: EXEC sp_Get_Clients_ByCompany @Company_ID = 3357
-- =============================================
CREATE OR ALTER PROCEDURE [dbo].[sp_Get_Clients_ByCompany]
    @Company_ID INT
AS
BEGIN
    SET NOCOUNT ON;
