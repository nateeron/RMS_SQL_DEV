USE [Pipeline]
GO
/****** Object:  StoredProcedure [dbo].[sp_Get_Report_RecruitmentProcess_bySales]    Script Date: 2/9/2026 11:47:16 AM ******/
SET ANSI_NULLS ON
GO
...
BEGIN TRY
    ...
    EXEC sp_executesql
        @SQL,
        N'@DateFrom DATETIME, @DateTo DATETIME, @Company_ID INT, @Position_ID_str NVARCHAR(500), @Owner_ID_str NVARCHAR(500) ,@Client_ID_str NVARCHAR(500)',
        @DateFrom, @DateTo, @Company_ID, @Position_ID_str, @Owner_ID_str,@Client_ID_str;
