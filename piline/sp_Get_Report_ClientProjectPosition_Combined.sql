USE [Pipeline]
GO
/****** Object:  StoredProcedure [dbo].[sp_Get_Report_ClientProjectPosition_Combined]    Script Date: 12/18/2025 1:59:45 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN CATCH 
	...
	VALUES (
		'1',
		'DB Pipeline - sp_Get_Report_ClientProjectPosition_Combined',
		ERROR_MESSAGE(),
		0,
		GETDATE()
	);
